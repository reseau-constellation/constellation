  ...
  module: {
    ...
    rules: [
        ...
        use: [
          /* config.module.rule('vue').use('cache-loader') */
          {
            ...
            options: {
              ...
              cacheIdentifier: '436c2869'
            }
          },
          /* config.module.rule('vue').use('vue-loader') */
          {
            loader: '/Users/julienmalard/atom/reseau/node_modules/vue-loader/lib/index.js',
            options: {
              compilerOptions: {
                whitespace: 'condense'
              },
        ...
        oneOf: [
          /* config.module.rule('css').oneOf('vue-modules') */
          {
            ...
            use: [
              ...
              {
                loader: '/Users/julienmalard/atom/reseau/node_modules/postcss-loader/src/index.js',
                options: {
                  sourceMap: false,
                  plugins: [
              ...
              /* config.module.rule('scss').oneOf('vue-modules').use('sass-loader') */
              {
                ...
                options: {
                  ...
                  implementation: {
                    ...
                    info: 'dart-sass\t1.35.1\t(Sass Compiler)\t[Dart]\ndart2js\t2.13.3\t(Dart Compiler)\t[Dart]',
                    types: {
                      Boolean: function () {
                        return _call(f, Array.prototype.slice.apply(arguments));
                      },
      ...
      /* config.module.rule('eslint') */
      {
        ...
        exclude: [
          /node_modules/,
          '/Users/julienmalard/atom/reseau/node_modules/@vue/cli-service/lib'
        ],
        use: [
          /* config.module.rule('eslint').use('eslint-loader') */
          {
            loader: '/Users/julienmalard/atom/reseau/node_modules/eslint-loader/index.js',
            options: {
              extensions: [
                '.js',
                '.jsx',
